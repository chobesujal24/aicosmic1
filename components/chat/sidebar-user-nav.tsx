      ...
      <SidebarMenuItem>
        <DropdownMenu>
            ...
            {loading || !user ? (
              ...
              >
                <div
                  ...
                  style={{
                    background: `linear-gradient(135deg, oklch(0.35 0.08 ${emailToHue(user.email ?? "guest")}), oklch(0.25 0.05 ${emailToHue(user.email ?? "guest") + 40}))`,
                  }}
                />
          ...
          >
            ...
            <DropdownMenuItem
              className="cursor-pointer text-[13px]"
              data-testid="user-nav-item-plans"
